...
const Items = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://osrs.openrune.dev/public/item/?${nullsParam}`);
  ...
  const handleDownloadItemIcon = async (item) => {
    const response = await fetch(`https://osrs.openrune.dev/public/item/${item.id}/icon`);
  ...
  const handleRowClick = async (item) => {
    try {
      const response = await fetch(`https://osrs.openrune.dev/public/item/${item.id}`);
