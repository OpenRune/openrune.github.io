...
export default function CacheTypeModal({
  ...
  const { selectedCacheType, setSelectedCacheType, availableCacheTypes, cacheStatuses, checkingStatuses, refreshStatuses } = useCacheType();
  ...
  const isAnyChecking = Array.from(checkingStatuses).length > 0;
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          <div className="flex items-center gap-3">
            ...
            >
              <IconRefresh size={16} className={isAnyChecking ? 'animate-spin' : ''} />
